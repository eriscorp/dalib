...
/// <summary>
///     Coverage for 0x36 UserList (S->C) - the online-user list. Pins the wire layout (including the
///     duplicated u16 count); verifies accumulation and round-trips through the codec.
/// </summary>
