...
/// <summary>
///     Coverage for 0x38 Refresh (C->S) - a bodyless trigger packet. Pins the empty body and the
///     round-trip.
/// </summary>
public class RefreshPacketTests
{
    ...
    {
        var packet = new RefreshPacket();

        packet.ToBody().Should().BeEmpty();
    }

    [Fact]
    public void RoundTrip_ThroughCodec_ParsesAsRefresh()
    {
